...
Public Class Main_Screen
    ...
    Dim updateonly As Boolean = False
    ...
    Private Sub Main_Function()
        Try
            ...
            If My.Computer.FileSystem.FileExists((Application.StartupPath & "\" & "config.aup").Replace("\\", "\")) = True Then
                ...
                Label1.Text = "Checking config.aup"
                ...
                If manifest.Length > 17 Then
                    Label3.Text = "Updating " & manifest.Remove(0, 17)
                ...
                Try
                    If My.Computer.FileSystem.FileExists((Application.StartupPath & "\" & "config.aup").Replace("\\", "\")) = True Then
                        filereader = My.Computer.FileSystem.OpenTextFileReader((Application.StartupPath & "\" & "config.aup").Replace("\\", "\"))
                        Label1.Text = "Parsing config.aup"
                        While filereader.Peek <> -1
                            temp = filereader.ReadLine()
                        ...
                        If manifest.Length > 9 Then
                            ...
                            If manifest.Length > 0 Then
                                ...
                                Try
                                    If My.Computer.FileSystem.FileExists((Application.StartupPath & "\7za.exe").Replace("\\", "\")) = False Then
                                        ...
                                        If My.Computer.Network.IsAvailable() = True Then
                                            Label1.Text = "Downloading Archive Utility"
                                ...
                                Try
                                    If My.Computer.Network.IsAvailable() = True Then
                                        Label1.Text = "Downloading Manifest"
                                        ...
                                        For Each m_node In m_nodelist
                                            ...
                                            If m_node.ChildNodes.Count = 5 Then
                                                ...
                                                If downloadfile = True Then
                                                    ...
                                                    Try
                                                        If My.Computer.Network.IsAvailable() = True Then
                                                            Label1.Text = "Downloading Required Update"
                                                            ...
                                                            If My.Computer.FileSystem.FileExists(filepath) = True Then
                                                                ...
                                                                Label1.Text = "Extracting Compressed Download"
                                                                ...
                                                                Dim rinfo As FileInfo = New FileInfo((Application.StartupPath & tempfilepath.Remove(tempfilepath.Length - filename.Length, filename.Length)).Replace("\\", "\"))
                                                                Dim fileoriginalname, filerenamename As String
                                                                fileoriginalname = rinfo.FullName
                                                                filerenamename = rinfo.FullName.Replace("xxxx_26xxxx", "&").Replace("xxxx_23xxxx", "#")
                                                                If fileoriginalname <> filerenamename Then
                                                                    rinfo.MoveTo(filerenamename)
                                                                End If
                                                                rinfo = Nothing
                ...
                For Each fil As String In My.Application.CommandLineArgs
                    If fil.Length > 0 Then
                        If fil.ToLower = "force" Or fil.ToLower = "f" Then
                            runApplication = True
                        End If
                        If fil.ToLower = "updateonly" Then
                            updateonly = True
                        End If
                    End If
                Next
                ...
                If Application.ExecutablePath.ToLower.EndsWith("autoupdate.exe") = True Then
                    ...
                    If runApplication = True Then
                        If updateonly = True Then
                            Shell(Application.ExecutablePath.Replace("AutoUpdate.exe", "AutoUpdate_Launcher.exe") & " force updateonly", AppWinStyle.NormalFocus, False)
                        Else
                    ...
                    Else
                        If updateonly = True Then
                            Shell(Application.ExecutablePath.Replace("AutoUpdate.exe", "AutoUpdate_Launcher.exe") & " updatedonly", AppWinStyle.NormalFocus, False)
                        Else
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        Log_Handler("**************************************************" & vbCrLf)
        Log_Handler("AutoUpdate execution complete." & vbCrLf)
